...
parser.add_argument('--dataset', default='OTB', type=str,
                    help='dataset name')
parser.add_argument('--data_base_path', default='/home/xiangyu/patch-attack/pysot-master/testing_dataset', type=str)
parser.add_argument('--model_name', default='siamrpn_r50_l234_dwxcorr', type=str)
...
def eval_patch(patch_img=None,height_start=None, height_end=None, width_start=None, width_end=None):
    img = cv2.imread(patch_img)
    cropped = img[height_start:height_end, width_start:width_end]
    cv2.imwrite(os.path.join(args.data_base_path, args.dataset, 'example.jpg'))
